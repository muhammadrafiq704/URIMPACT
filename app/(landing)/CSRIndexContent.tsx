...
const CSRIndexContent = () => {
    return (
        <>
            <div className="flex-1 flex flex-col gap-6 rounded-2xl bg-[#0F172A] border border-[#33415580] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] backdrop-blur-xl p-5">
                ...
                <div className="flex items-center justify-center gap-4">
                    <div className="rounded-lg bg-[#1E293B80] p-4 text-center w-full">
                        <p className="text-[#FFFFFF] font-bold text-[clamp(16px, 4vw, 24px)] leading-8 mb-1">12,450</p>
                    ...
                    <div className="rounded-lg bg-[#00B8A51A] p-4 text-center justify-center w-full">
                        <div className="flex items-center justify-center gap-1">
                            ...
                            <p className="text-(--color-primary) font-bold text-[clamp(16px, 4vw, 24px)] leading-8">15%</p>
                        </div>
                    ...
                    <div className="rounded-lg bg-[#305F431A] p-4 text-center w-full">
                        <div className="flex items-center justify-center gap-1">
                            ...
                            <p className="text-[#305F43] font-bold text-[clamp(16px, 4vw, 24px)] leading-8">98.2%</p>
                        </div>
                ...
                <div className=" flex flex-col gap-2 w-full">
                    <div className="flex items-center justify-between">
                        ...
                        <p className="text-white font-medium text-sm leading-5">78%</p>
                    </div>
